...
abstract final class DopaminePushCoordinator {
  ...
  ///
  /// Must run while Firebase Auth still has a signed-in user (before logout or
  /// account deletion). Otherwise `dopamine_device_push_tokens` keeps the
  /// uid→token mapping and market-daily / hot-mover crons (and social notify
  /// while the uid still exists) continue delivering to this device.
